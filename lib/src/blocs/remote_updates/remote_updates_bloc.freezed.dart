...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<SyncDataEntity> data)?  success,TResult Function( dynamic error)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<SyncDataEntity> data)  success,required TResult Function( dynamic error)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<SyncDataEntity> data)?  success,TResult? Function( dynamic error)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _LoadInProgress() when loading != null:
return loading();case _RemoteUpdatesFetched() when success != null:
...
class _RemoteUpdatesFetched implements RemoteUpdatesState {
  const _RemoteUpdatesFetched(final  List<SyncDataEntity> data): _data = data;
  

 final  List<SyncDataEntity> _data;
 List<SyncDataEntity> get data {
